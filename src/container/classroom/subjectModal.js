...
const SubjectModal = ({ isVisible, handleOk, handleCancel }) => {
  ...
  return (
    ...
    >
      ...
      <DatePicker onChange={onChange} style={{ width: 300}} />
       ...
       <div  >
      <label style={{padding:1}}>Subject Name</label> &nbsp; <br />
      <Input style={{ width: 300}} />
      </div><br />
      <div  >
      <label style={{padding:1}}>Subject Code</label> &nbsp; <br />
      <Input style={{ width: 300}} />
      </div><br />
       <div  >
      <label style={{padding:1}}>Subject Type</label> &nbsp; <br />
      <Select defaultValue="Theory" size="small" style={{ width: 300}} >
          <Option>Theory</Option>
          <Option>Lap</Option>
       </Select>
      </div><br />
      <div  >
      <label style={{padding:1}}>Class</label> &nbsp; <br />
