  ...
  return (
    <>
      ...
      <Main>
        ...
        <Modal destroyOnClose={true} type={state.modalType} title={null} visible={state.visible} footer={null} onCancel={handleCancel}>
          <div className="project-modal">
            <BasicFormWrapper>
              <Form preserve={false}form={form} name="createProject" onFinish={handleOk}>
                <Form.Item
