...
import { getGradesReducer} from'./grade/reducers'
import{ getOrgReducer} from './OrgId/reducers'

import {examListReducer,
  examDeleteReducer,
  examSaveReducer,
  examTypeListReducer,
...
const rootReducers = combineReducers({
  examLists: examListReducer,
  exam:examSaveReducer,
  examDelete:  examDeleteReducer,
  examTypeLists: examTypeListReducer,
  examTypeDelete: examTypeDeleteReducer,
  examType: examTypeSaveReducer,
  getOrgReducer: getOrgReducer,
  getGradesReducer :getGradesReducer,
